...
grouping, footnote handling, and a unified rendering pipeline for both
Word/PDF (`gt`) and interactive HTML (`reactable`) output.
...
- 🎨 **Dual render targets** — `render_gt()` for Word/PDF, `render_reactable()` for HTML
...
| Role | Name |
|------|------|
| Author, maintainer | [Lucas G. S. França](https://github.com/lgsfr) |
...
- 🔗 [**syncR**](https://github.com/circadia-bio/syncR) — integrates zeitR, slumbR, and tallieR into a unified database
